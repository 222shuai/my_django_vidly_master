...
SECRET_KEY = 'django-insecure-cjfau%+0baij#%hra-66^*1z^4p19)kj%%-ovb%+o82s5jpe)t'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'my_django_vidly',  # 需要提前在mysql中建好这个名称的数据库
        'USER': 'root',
        'PASSWORD': 'shuai20011025.',
        'HOST': 'localhost',
        'PORT': '3306',
    }
}
...
STATICFILES_DIRS = [  # 静态文件css、js、images
